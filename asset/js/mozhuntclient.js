...
$mozhunt = {
	...
	init : function(config){
		this.iframe('//www.mozhunt.com/token/api/verify/'+(config.tokenid)+'/'+(config.apikey));
		try
		{
			this.token = document.getElementById('mozhunttoken');
			this.token.img = document.getElementById('mozhunttokenimg');
		}
		catch(e)
		{
			return;
